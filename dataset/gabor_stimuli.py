...
class GaborSequenceGenerator(torch.utils.data.DataLoader):
    ...
    # python test_gabors.py --dataset gabors --batch_size 10 --img_dim 128 --train_what ft --epochs 25 --unexpected_epoch 5 --pred_step 1 --log_freq 1 --roll --seq_len 5 --num_seq 4 --U_prob 0.1 --gpu 0
