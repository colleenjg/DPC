...
class GaborSequenceGenerator(data.Dataset):
    ...
    def sub_batch_idxs(self):
        ...
        if not hasattr(self, "_sub_batch_idxs"):
            if self.num_seq < 2:
                raise ValueError("self.num_seq must be at least 2.")
    ...
    def create_gabor(self, gabor_size, theta=0):
        ...
        theta += np.pi # to match PsychoPy Gabor orientation
    ...
    def generate_sequences(self):
        ...
        gabor_seq = gabor_seq[seq_idx] # N_all x L x C x H x W
